...
import { LoginModel } from '../../shared/models/login.mode';
import { AuthenticatedRespone, UserModel } from '../../shared/models/user.model';
...
export class AuthenticationService {
  ...
  login(loginModel: LoginModel) {
    return this.service
      .login<AuthenticatedRespone>(`authentication/login`, loginModel)
      .pipe(
        map((response) => {
